...
static const char *colors[][3]      = {
    /*               fg         bg         border   */
    [SchemeNorm] = { white,     black,     black },  /* белый на черном */
	[SchemeStatus]  = { white, black,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { black, white, black  }, // Tagbar left selected {text,background,not used but cannot be empty}
    ...
    [SchemeSel]  = { black,     black,     white },  /* черный на белом */
};
